...
//           <span className="">Practicing Fast Math Skills</span>
//         </Link>
...
// const Header = () => {
//   const { user, signOut } = useAuth(); // ไม่ต้องดึง userRole มาใช้แล้ว

//   // === กำหนดอีเมลที่เป็น ADMIN ที่นี่ ===
//   // คุณสามารถใส่อีเมลของคุณเองลงไปในนี้ได้เลย
//   const adminEmails = ["praengkhong@gmail.com"];

//   // ฟังก์ชันเช็กว่าเป็น Admin หรือไม่
...
//           {user && (
//             <>
//               {/* ส่วนแสดงลิงก์ Admin เฉพาะคนที่มีอีเมลตรงกัน */}
//               {isAdmin && (
//                 <NavLink 
//                   to="/admin" 
//                   className={({ isActive }) => `px-3 py-2 rounded-md text-sm ${isActive ? 'bg-accent text-accent-foreground' : 'hover:bg-accent hover:text-accent-foreground'}`}
//                 >
//                   ผู้ดูแล
//                 </NavLink>
//               )}
...
//                 {/* เมนู Admin ใน Dropdown */}
//                 {isAdmin && (
//                   <>
//                     <DropdownMenuSeparator />
//                     <DropdownMenuItem asChild className="text-red-600 font-bold cursor-pointer bg-red-50">
//                       <Link to="/admin">จัดการระบบ (Admin)</Link>
//                     </DropdownMenuItem>
//                   </>
//                 )}
